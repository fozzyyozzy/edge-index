...
export default function App() {
  ...
  const NAV = [
    ...
    {id:"nfl",        l:"Props"},
    {id:"parlays",    l:"Parlays"},
    {id:"playbook",   l:"Playbook"},
    {id:"streaks",    l:"Streaks"},
    {id:"players",    l:"Player Stats"},
    ...
    <>
      ...
      <nav className="nav">
        ...
        <div className="nav-right">
          {unlocked
            ? <span className="nav-badge">MEMBER</span>
            : <button className="btn-unlock" onClick={()=>setShowM(true)}>Unlock</button>
          }
        </div>
      </nav>
      ...
      {tab==="playbook" && <PlaybookHub/>}
      {tab==="streaks" && <StreakCenter/>}
      {tab==="players" && <PlayerStatsHub/>}
      {tab==="results" && <ResultsPage/>}
      {tab==="model"   && <ModelPage unlocked={unlocked}/>}
      {tab==="mlb"     && <MLBHub/>}
      {tab==="record"  && <RecordTracker/>}
